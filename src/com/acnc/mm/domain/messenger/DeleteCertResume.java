...
public class DeleteCertResume implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3298991389680279097L;
	...
	public DeleteCertResume(){
	
	}
	
	public DeleteCertResume(Long cerID, String certName, Date certYear, Long candinfo_id){
		this.cerID = cerID;
